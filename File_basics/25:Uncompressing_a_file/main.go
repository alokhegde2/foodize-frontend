//the following demonstration of how to uncompress a file using the gzip alogorithm

//This example uses gzip but standard library also
//supports zlib,bz2 etc
...
func main() {
	...
	//data source.It is comman for webserver
	//to return gzipped contents to save bandwidth
	//and in the case the data is not in a file
